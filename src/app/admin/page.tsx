...
export default async function AdminDashboard() {
  ...
  const stats = [
    {
      ...
      label: "Total users",
      value: userCount,
      context: `+${usersThisWeek} this week`,
    },
    {
      key: "lecturer",
      label: "Lecturers",
      value: lecturerCount,
      context:
        lecturerCount > 0 && lecturersActive === lecturerCount
          ? "all active"
          : `${lecturersActive} active`,
    },
    {
      key: "student",
      label: "Students",
      value: studentCount,
      context:
        studentCount > 0 && studentsActive === studentCount
          ? "all active"
    ...
    },
    {
      ...
      label: "Courses",
      value: courseCount,
      context: `${harmattanCount} Harmattan · ${rainCount} Rain`,
    },
    {
      key: "session",
      label: "Sessions",
  ...
  const activity = [
    recentUser && {
      text: `Created user: ${recentUser.name}`,
      at: recentUser.createdAt,
    },
    recentCourse && {
      text: `Created course: ${recentCourse.code}`,
      at: recentCourse.createdAt,
    },
    recentEndedSession?.endedAt && {
      text: `Session ended · ${recentEndedSession.course.code}`,
      at: recentEndedSession.endedAt,
    },
    recentAttendance && {
      text: `${recentAttendance.student.name} marked present`,
      at: recentAttendance.markedAt,
    },
    recentActivation?.usedAt && {
      text: `${recentActivation.user.name} activated their account`,
      at: recentActivation.usedAt,
    },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-3">
        {stats.map((s) => (
          <div key={s.key} className="rounded-lg bg-slate-50 p-3.5 shadow-card">
